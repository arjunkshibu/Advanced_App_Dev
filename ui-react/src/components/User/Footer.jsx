...
const Footer = () => {
  return (
<div className="min-h-[60px] font-Montserrat absolute bottom-0 w-screen bg-black flex overflow-hidden flex-col md:flex-row md:items-center md:justify-between">
      <div className="">
