    ...
    <div className="-z-10">
      <div class=" inset-0 flex justify-center items-center absolute right-0">
        <div class="grid grid-cols-3 grid-rows-3 gap-4 ml-32">
          ...
          <div class="h-52 w-96 bg-syn-lb flex flex-col hover:bg-syn-lb justify-center items-center">
          ...
          </div>          <div class="h-52 w-96 bg-syn-lb hover:bg-syn-lb flex flex-col justify-center items-center">
            <div class="flex items-center justify-center">
              <Laptop size={50} />
            </div>
            <div class="flex justify-center items-center text-4xl">
