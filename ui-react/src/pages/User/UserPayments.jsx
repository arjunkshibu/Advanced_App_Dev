...
const UserPayments = () => {
  ...
  const courses = [
    ...
    { slNo: 2, name: 'JavaScript Fundamentals', duration: '6 weeks', fee: '$120', paymentStatus: 'Pending' },
    ...
    { slNo: 5, name: 'Python Programming', duration: '10 weeks', fee: '$180', paymentStatus: 'Pending' },
    ...
    { slNo: 8, name: 'Machine Learning Basics', duration: '8 weeks', fee: '$170', paymentStatus: 'Pending' },
